...
This module implements a Least Recently Used (LRU) caching mechanism
represented by the `LRUCache` class. It allows storing and
retrieving items from a dictionary with an LRU removal mechanism
...
class LRUCache(BaseCaching):
    ...
    dictionary with a Least Recently Used (LRU) removal mechanism
